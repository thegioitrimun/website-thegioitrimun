                    ...
                    <div className="lg:w-1/2 w-full flex flex-col justify-center px-5 sm:px-8 lg:px-0">
                        ...
                        <div className="mt-6 grid gap-3 sm:grid-cols-2 md:grid-cols-3">
                            {detailCopy.trustBadges.map((badge, index) => {
                                ...
                                return (
                                    <div key={badge.title} className="rounded-[22px] border border-border bg-white p-4 shadow-sm dark:border-white/10 dark:bg-card">
                                    ...
                                    <div className="relative ml-4 space-y-8 border-l-2 border-primary/20 pl-6 md:ml-6 md:pl-10 md:space-y-12">
                                        {service.procedure_steps.map((step) => (
                                            <div key={step.id} className="relative">
                                                ...
                                                <div className="rounded-[22px] bg-muted/30 p-4 md:p-6 dark:bg-card dark:border dark:border-white/10">
                            ...
                            <div className="bg-card p-6 rounded-xl shadow-lg">
                                ...
                                {supportProducts.length > 0 && (
                                    <button
                                        ...
                                        className="w-full mt-3 rounded-full border border-border bg-white px-6 py-3 text-sm font-bold text-foreground transition-colors hover:border-primary/40 hover:text-primary btn-press dark:border-white/10 dark:bg-card dark:hover:border-primary/40"
                                    >
