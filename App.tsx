...
const ServicesPage = lazyWithRetry(() => import('./components/ServicesPage'), 'ServicesPage');
const Sidebar = lazyWithRetry(() => import('./components/Sidebar'), 'Sidebar');
const FullScreenSearch = lazyWithRetry(() => import('./components/FullScreenSearch'), 'FullScreenSearch');
const ServiceDetailPage = lazyWithRetry(() => import('./components/ServiceDetailPage'), 'ServiceDetailPage');
const AboutPage = lazyWithRetry(() => import('./components/AboutPage'), 'AboutPage');
const BlogPage = lazyWithRetry(() => import('./components/BlogPage'), 'BlogPage');
const BlogPostPage = lazyWithRetry(() => import('./components/BlogPostPage'), 'BlogPostPage');
const IngredientAnalyzerPage = lazyWithRetry(() => import('./components/IngredientAnalyzerPage'), 'IngredientAnalyzerPage');
const AdministrativeProfilePage = lazyWithRetry(() => import('./components/AdministrativeProfilePage'), 'AdministrativeProfilePage');
const MedicalRecordsPage = lazyWithRetry(() => import('./components/MedicalRecordsPage'), 'MedicalRecordsPage');
const MyMedicalRecordsPage = lazyWithRetry(() => import('./components/MyMedicalRecordsPage'), 'MyMedicalRecordsPage');
const AppointmentsPage = lazyWithRetry(() => import('./components/AppointmentsPage'), 'AppointmentsPage');
const BookingPage = lazyWithRetry(() => import('./components/BookingPage'), 'BookingPage');
const AuthPage = lazyWithRetry(() => import('./components/AuthPage'), 'AuthPage');
const BrandDirectoryPage = lazyWithRetry(() => import('./components/BrandDirectoryPage'), 'BrandDirectoryPage');
const BrandLandingPage = lazyWithRetry(() => import('./components/BrandLandingPage'), 'BrandLandingPage');
...
const CheckoutSuccessPage = lazyWithRetry(() => import('./components/CheckoutSuccessPage'), 'CheckoutSuccessPage');
const OrderLookupPage = lazyWithRetry(() => import('./components/OrderLookupPage'), 'OrderLookupPage');
const WishlistPage = lazyWithRetry(() => import('./components/WishlistPage'), 'WishlistPage');
const AccountPage = lazyWithRetry(() => import('./components/AccountPage'), 'AccountPage');
const OrderHistoryPage = lazyWithRetry(() => import('./components/OrderHistoryPage'), 'OrderHistoryPage');
const ProductsPage = lazyWithRetry(() => import('./components/ProductsPage'), 'ProductsPage');
const loadProductDetailPage = () => import('./components/ProductDetailPage');
const ProductDetailPage = lazyWithRetry(loadProductDetailPage, 'ProductDetailPage');
